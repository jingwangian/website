...
class Airline(models.Model):
    ...
    to_city = models.IntegerField(blank=True, null=True)
...
class Flight(models.Model):
    ...
    stay_days = models.IntegerField(blank=True, null=True)
    adults = models.IntegerField(blank=True, null=True)
    children = models.IntegerField(blank=True, null=True)
    children_age = models.TextField(blank=True, null=True)  # This field type is a guess.
    cabinclass = models.IntegerField(blank=True, null=True)
...
class FlightPrice(models.Model):
    ...
    span_days = models.IntegerField(blank=True, null=True)
